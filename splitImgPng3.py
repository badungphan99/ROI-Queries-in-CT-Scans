...
label_2 = "/mnt/32D84D55D84D188D/ubuntu-data-hdd/data-for-haar-knn/data_label/2"

label_5 = "/mnt/32D84D55D84D188D/ubuntu-data-hdd/data-for-haar-knn/data_label/5"

label_8 = "/mnt/32D84D55D84D188D/ubuntu-data-hdd/data-for-haar-knn/data_label/8"
...
for hpp in head_path:
    ...
    for i in list_br:
        path_img = os.path.join(head_images,i)
        img_data = cv2.imread(path_img, 0)
        imgwrite = os.path.join(label_2, datetime.datetime.now().strftime("%d-%m-%Y:%H:%M:%S:%f") + ".png")
...
for cpp in chest_path:
    ...
    for i in range(start, end):
        ...
        img_data = cv2.imread(path_img, 0)
        imgwrite = os.path.join(label_5, datetime.datetime.now().strftime("%d-%m-%Y:%H:%M:%S:%f") + ".png")
        cv2.imwrite(imgwrite, img_data)
...
for app in abdominal_path:
    ...
    for i in range(start, end):
        ...
        img_data = cv2.imread(path_img, 0)
        imgwrite = os.path.join(label_8, datetime.datetime.now().strftime("%d-%m-%Y:%H:%M:%S:%f") + ".png")
        cv2.imwrite(imgwrite, img_data)
